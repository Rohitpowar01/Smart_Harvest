...
if (isset($_POST['custupdate'])) {
    ...
    // Update query only if fields are not empty
    $update_fields = array();
    if (!empty($name)) $update_fields[] = "cust_name='$name'";
    if (!empty($email)) $update_fields[] = "email='$email'";
    if (!empty($mobile)) $update_fields[] = "phone_no='$mobile'";
    if (!empty($statename)) $update_fields[] = "state='$statename'";
    if (!empty($district)) $update_fields[] = "district='$district'";
    if (!empty($address)) $update_fields[] = "address='$address'";
    if (!empty($pincode)) $update_fields[] = "pincode='$pincode'";
    if (!empty($pass)) $update_fields[] = "password='$pass'";

    // Construct the update query
    $update_query1 = "UPDATE custlogin SET " . implode(", ", $update_fields) . " WHERE cust_id='$id'";
                            ...
                            <div class="modal-body bg-gradient-danger">
                                ...
                                <form class="col s12 l5 white-text" method="POST" autocomplete="new-password">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label text-white">Customer ID</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Customer
                                            Name </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Email
                                            Address </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Mobile
                                            No </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Address
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Pincode
                                        </label>
                                        <div class="col-md-9">
