...
if (isset($_POST['send_otp'])) {
    ...
    $res = mysqli_query($conn, "SELECT * FROM customerlogin WHERE email='$email'");
    $count = mysqli_num_rows($res);
    if ($count > 0) {
        $otp = rand(11111, 99999);
        mysqli_query($conn, "UPDATE customerlogin SET otp='$otp' WHERE email='$email'");
...
if (isset($_POST['verify_otp'])) {
    ...
    $res = mysqli_query($conn, "SELECT * FROM customerlogin WHERE email='$email' AND otp='$otp'");
    $count = mysqli_num_rows($res);
    if ($count > 0) {
...
if (isset($_POST['reset_password'])) {
    ...
    $email = $_SESSION['customer_email'];
    mysqli_query($conn, "UPDATE customerlogin SET password='$new_password', otp=NULL WHERE email='$email'");
