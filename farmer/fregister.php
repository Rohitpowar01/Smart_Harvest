            ...
            <div class="row">
                <div class="col-sm-12 mb-3">
                    ...
                    <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active font-weight-bold text-warning" id="nav-home-tab"
                            data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home"
                            aria-selected="true">Farmer Signup</a>
                                ...
                                <form name="insert" action="" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Farmer Name
                                            <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Mobile No
                                            <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="number" name="mobile" required="true"
                                                pattern="[6789][0-9]{9}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Bank Name
                                            <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="bank_nm" required="true" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Bank IFSC Code
                                            <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="ifsc_cd" required="true" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Account Number
                                            <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                            <input class="form-control" min="10" type="number" name="acct_num" required="true" />
                                        </div>
                                    </div>


                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white" required="true">
                                            State <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
					...
					?>
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white" required="true">
                                            District <strong class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white">City <strong
                                                class="text-default"> *</strong></label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group mb-3">
                                                ...
                                                <span class="text-white d-block"> Use minimum 8 Characters with atleast
                                                    1 numericals, Capital letter and Special Character. </span>
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white">Confirm Password
                                            <strong class="text-default"> *</strong></label>
                                        <div class="col-9">
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                ...
                                                <input name="confirmpassword" type="password" class="input form-control"
                                                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="cpassword"
                                                    placeholder="password" required="true" aria-label="password"
                                                    aria-describedby="basic-addon1" />
                                                <div class="input-group-append">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <button name="farmerregister" class=" btn-block btn btn-success"><span
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-sm-2 col-5 ">
                    <h5>Our Address</h5>
                    <address>
                        Brahmanwada, Majali<br>
                        Karwar - 581 345, Karnataka<br>
                        <div class="btn-group text-center" role="group">
                            <a role="button" class="btn btn-primary" href="tel:+918431782947"><i
                                    class="fa fa-phone"></i> Call</a>
                            <a role="button" class="btn btn-info" href="tel:+918431782947"> <i class="fa fa-fax"></i>
                                Fax</a>
                            <a role="button" class="btn btn-success" href="mailto:smartharvest.ind@gmail.com"> <i
                ...
                <div class="col-12 col-md-3 align-self-center">
                    <div class="social-network  text-center">
                        ...
                        <button target="_blank" href="/" rel="nofollow"
                            class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip"
            ...
            <div class="row justify-content-center">
                <div class="col-auto">
                    <p>&copy; Copyright 2024 SMART HARVEST, All Rights Reserved </p>
                </div>
            </div>
        </div>
    </footer>
