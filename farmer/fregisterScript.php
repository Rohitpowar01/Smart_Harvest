...
function create_user($name, $password, $email, $mobile, $gender, $dob, $statename, $district, $city, $bank_nm, $ifsc_cd, $acct_num) 
{
	global $conn;
	
      $query = "INSERT INTO `farmerlogin` (farmer_name, password, email, phone_no, F_gender, F_birthday, F_State, F_District, F_Location, bank_nm, ifsc_cd, acct_num)
	  VALUES ('$name', '$password', '$email', '$mobile', '$gender', '$dob', '$statename', '$district', '$city','$bank_nm', '$ifsc_cd', '$acct_num')";
...
if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirmpassword'])){
    ...
    {	
        if (create_user($name, $password, $email, $mobile, $gender, $dob, $statename, $district, $city, $bank_nm, $ifsc_cd, $acct_num)) {
