...
$query5 = "SELECT StateName from state where StCode ='$state'";
	$ses_sq5 = mysqli_query($conn, $query5);
              ...
              acct_num='$acct_num',
              password='$pass',
              F_State = CASE WHEN '$state' != '' THEN '$statename' ELSE F_State END,
              F_District = CASE WHEN '$district' != '' THEN '$district' ELSE F_District END,
              F_Location = CASE WHEN '$city' != '' THEN '$city' ELSE F_Location END
              WHERE farmer_id='$id'";
                    ...
                    <div class="card">
                        <div class="card-body bg-gradient-warning">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="../assets/img/agri.png" alt="agri" class=" rounded-circle img-fluid"
                                    width="212px">
                                <div class="mt-3">
                                    <h4> Welcome <?php echo $login_session ?></h4>
                                    <button data-toggle="modal" data-target="#edit" class="btn btn-danger">Edit
                                        Profile</button>
                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body bg-gradient-success">
                            ...
                            <div class="row mb-1">
                                <div class="col-sm-3">
                                    <h6 class="mb-0 font-weight-bold">Bank Name</h6>
                                </div>
                                <div class="col-sm-9 text-dark">
                                    <?php echo $para12 ?>
                                </div>
                            ...
                            <div class="row mb-1">
                                <div class="col-sm-3">
                                    <h6 class="mb-0 font-weight-bold">Bank IFSC Code</h6>
                                </div>
                                <div class="col-sm-9 text-dark">
                                    <?php echo $para13 ?>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body bg-gradient-danger">
                                ...
                                <form class="col s12 l5 white-text" method="POST" autocomplete="new-password">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label text-white" for="bank_nm">Bank Name</label>
                                        <div class="col-md-9">
                                            <input class=" form-control" name="bank_nm" type="text"
                                                value="<?php echo "$para12"?>" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label text-white" for="ifsc_cd">Bank IFSC Code</label>
                                        <div class="col-md-9">
                                            <input class=" form-control" name="ifsc_cd" type="text"
                                                value="<?php echo "$para13"?>" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label text-white" for="acct_num">Account Number</label>
                                        <div class="col-md-9">
                                            <input class=" form-control" name="acct_num" type="number"
                                                value="<?php echo "$para14"?>" />
                                        </div>
                                    </div>
