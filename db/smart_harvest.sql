...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2024 at 04:14 PM
...
(8, 'rohit', '8431782947', 'rohitpowar0109@gmail.com', 'Opp rachna factory Brahmanwada majali karwar', 'hello');
...
INSERT INTO `custlogin` (`cust_id`, `cust_name`, `password`, `email`, `address`, `district`, `pincode`, `state`, `phone_no`, `otp`) VALUES
(19, 'Rohit', 'Rohit@0123', 'rohitpowar0109@gmail.com', 'Opp rachna factory Brahmanwada majali karwar', 'Uttara Kannada', '581345', 'Karnataka', '08431782947', 0),
(20, 'Rohit', 'Rohit@01', 'rohitslayer01@gmail.com', 'Opp rachna factory Brahmanwada majali karwar', 'Kodagu', '581345', 'Karnataka', '8431782947', 0),
(21, 'Pratik S Powar', 'Pratik@01', 'pratikpowar85@gmail.com', 'Opp rachna factory Brahmanwada majali karwar', 'Uttara Kannada', '581345', 'Karnataka', '8660599728', 0);
...
INSERT INTO `farmerlogin` (`farmer_id`, `farmer_name`, `password`, `email`, `phone_no`, `F_gender`, `F_birthday`, `F_State`, `F_District`, `F_Location`, `bank_nm`, `ifsc_cd`, `acct_num`, `otp`) VALUES
(44, 'Farmer', 'Farmer@123', 'pratikpowar0227@gmail.com', '8660599728', 'Male', '2001-09-22', 'Karnataka', 'Mangalore', 'Bantakal', '', '', 0, 0),
(60, 'Pratik', '123456', 'Pratik', '07795232434', 'Male', '1999-06-20', 'Karnataka', 'Dharwad', 'Karwar', '', '', 0, 0),
(61, 'Rohit', 'Rohit@123', 'rohitpowar0109@gmail.com', '8431782947', 'Male', '2003-09-01', 'Karnataka', 'Uttara Kannada', 'Karwar', 'HDFC Bank', 'CNBR0001029', 111111111, 0),
(62, 'Aditya', 'Aditya@01', 'naditi161@gmail.com', '9632907683', 'Male', '2003-05-21', 'Karnataka', 'Uttara Kannada', 'Karwar', '', '', 0, 0),
(65, 'Pratik S Powar', 'Pratik@01', 'pratikpowar85@gmail.com', '8660599728', 'Male', '1999-06-02', 'Karnataka', 'Uttara Kannada', 'Pratik', 'HDFC Bank', 'CNBR0001025', 1234567888, 0),
(66, 'Rohit', 'Rohit@01', 'rohitslayer01@gmail.com', '8431782947', 'Male', '2003-09-01', 'Karnataka', 'Uttara Kannada', 'Karwar', 'Canara Bank', 'CNBR0001025', 1234567877, 0);
...
(121, 61, 'rice', 100, 32, 48),
(122, 61, 'rice', 100, 33, 50),
(129, 61, 'soyabean', 75, 15, 22),
(132, 66, 'maize', 82, 15, 22);
...
INSERT INTO `farmer_history` (`History_id`, `farmer_id`, `farmer_crop`, `farmer_quantity`, `farmer_price`, `date`, `Status`, `Reason`) VALUES
(32, 63, 'moong', 100, 15, '2024-06-05 23:51:09', 'payment failed', 'Bank Doesnt Exist'),
(33, 63, 'moong', 100, 15, '2024-06-05 23:51:45', 'order pending', ''),
(34, 61, 'soyabean', 100, 15, '2024-06-06 00:33:25', 'delivered', ''),
(35, 64, 'wheat', 100, 18, '2024-06-06 20:11:41', 'order pending', ''),
(36, 64, 'soyabean', 100, 12, '2024-06-06 22:50:59', 'delivered', ''),
(37, 66, 'maize', 100, 15, '2024-06-06 23:21:35', 'shipping', '');
...
INSERT INTO `orders` (`order_id`, `cust_id`, `crop_name`, `quantity`, `price`, `order_date`, `status`) VALUES
(23, 19, 'rice', 1, 60, '2024-06-01 18:06:02', 'shipping'),
(24, 20, 'moong', 20, 440, '2024-06-06 14:37:45', 'order pending'),
(25, 20, 'soyabean', 10, 220, '2024-06-06 14:37:45', 'order pending'),
(26, 20, 'wheat', 15, 405, '2024-06-06 14:42:15', 'order pending'),
(27, 20, 'urad', 20, 300, '2024-06-06 17:14:19', 'order pending'),
(28, 20, 'bajra', 10, 150, '2024-06-06 17:18:56', 'order pending'),
(29, 21, 'maize', 18, 396, '2024-06-06 17:56:43', 'order pending'),
(30, 21, 'soyabean', 15, 330, '2024-06-06 17:56:43', 'order pending');
...
INSERT INTO `production_approx` (`crop`, `quantity`, `mrp_kg`) VALUES
('arhar', 100, 122),
('bajra', 90, 37),
('barley', 0, 28),
('cotton', 0, 68),
...
ALTER TABLE `cart`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `cropname` (`cropname`,`cust_id`) USING BTREE;
...
--
ALTER TABLE `farmerlogin`
  MODIFY `farmer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT for table `farmer_crops_trade`
--
ALTER TABLE `farmer_crops_trade`
  MODIFY `trade_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
